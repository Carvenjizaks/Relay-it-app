        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-card border border-border rounded-xl font-semibold hover:bg-accent transition-all"
              >
